  ...
  const contactInfo = [
    {
      icon: Phone,
      text: t("phone"),
      link: formatContactLink(data?.data?.data?.contacts?.phone1, "phone"),
      info: data?.data?.data?.contacts?.phone1,
    },
    {
      icon: Whatsapp,
      text: t("whatsapp"),
    ...
    },
    {
      icon: Email,
      text: t("email"),
      link: formatContactLink(data?.data?.data?.contacts?.email, "email"),
      info: data?.data?.data?.contacts?.email,
    },
  ];
  return (
    <>
